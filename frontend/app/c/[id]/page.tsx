      ...
      <div className={`w-full max-w-sm rounded-[36px] overflow-hidden ${NEU_FLAT} border border-white/40`}>
        <div className="px-6 py-6 space-y-5">
          ...
          <button
            ...
            className="w-full bg-gradient-to-br from-[#3f88fc] to-[#3575dd] text-white font-bold py-3.5 px-4 rounded-2xl flex items-center justify-center gap-2 text-sm tracking-wide shadow-[5px_5px_14px_#a9b8cc,-4px_-4px_12px_#ffffff] active:scale-[0.98] transition-transform mt-2"
          >
